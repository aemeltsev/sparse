...
static char RCSid[] =
    "@(#)$Header: /local/cvs/freeda/libs/sparse/spSolve.c,v 1.1.1.1 2004/02/25 18:15:35 nmkripla Exp $";
#endif
...
/**
 * @brief spSolve - SOLVE MATRIX EQUATION
 ...
 *
 * @def Obscure Macros - IMAG_VECTORS
...
/*VARARGS3*/
void spSolveTransposed(MatrixPtr Matrix, RealVector RHS, RealVector Solution IMAG_VECTORS)
{
    MatrixPtr Matrix = (MatrixPtr)eMatrix;
    ElementPtr pElement;
    RealVector Intermediate;
